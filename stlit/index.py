...
def call_sentiment_api(url):
    # Make an API call
    apiURL = "https://subhchaturvedi.pythonanywhere.com/get_sentimentanalysis_overall"
...
# def call_sentiment_api_test(url):
#     st.write(f'Average Sentiment: Neutral with score of 5.0')
